  ...
  return (
    ...
    >
      ...
      <DateTimePickerModal
        ...
        maximumDate={new Date(moment().add(1, "days").format("YYYY-MM-DD"))} // cannot go after the current day
        minimumDate={
          new Date(
      ...
      >
        <ChevronLeftIcon
          color={`${
            showLeftIcon ? customTheme.colors.primary : customTheme.colors.light
          }`}
        />
      </TouchableOpacity>
      ...
      <View>
        <TouchableOpacity onPress={toggleDateNavigation}>
          <Text style={{color: customTheme.colors.dark}} className="text-lg font-bold">
