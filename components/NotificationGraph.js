          ...
          try {
              if ((notification?.heartRates ?? []).length > 0) {
                  ...
                  const endIndexTime = moment(
                      notification?.heartRates[
                          notification?.heartRates.length - 1
                      ].timeStamp,
                      "HH:mm:ss"
                  ).diff(moment().startOf("d"), "minute");
                  ...
                  if (
                      ...
                      (adjustedActivityData.length != 0 &&
                          adjustedActivityData.reduce(
                              (a, b) => a + parseInt(b.y),
                              0
                          ) == 0)
                  ) {
                      adjustedActivityData = (
                          notification.heartRates ?? []
                      ).map((val) => {
                          return {
                              x: moment(val?.timeStamp, "HH:mm:ss")
                                  .toDate()
                                  .getTime(),
                              y: 1,
                          };
              ...
              Sentry.captureException(error, {
                  extra: {
                      message:
                          "Error while fetching data for notification data",
                  },
              });
          }
      };
      ...
      return (
          <View style={{ marginLeft: -40 }}>
                      ...
                      >
                          ...
                          >
                              {notification?.chartdate
                                  ? moment(notification.chartdate).format(
                                        "  MMM DD"
                                    )
                                  : moment
                                        .tz(notification.timestamp, "gmt")
              ...
              >
                  ...
                  <VictoryAxis
                      axisLabelComponent={
                          <VictoryLabel style={{ fontSize: 10 }} />
                      }
                      ...
                      <View>
                          ...
                          {data.activity.length !== 0 ? (
                              <ActivityChart
                                  ...
                                  loading={
                                      (notification?.heartRates?.length ??
                                          0) == 0
                                  }
                              />
                          ) : (
