...
const CustomTrendDatePicker = ({ changeDateRange, isDataLoading }) => {
  ...
  const goRight = () => {
    if (selectedMode === "week") {
      setStartDate(
        moment(startDate, "MMM DD, YYYY").add(1, "week").format("MMM DD, YYYY")
      );
      setEndDate(
        moment(endDate, "MMM DD, YYYY").add(1, "week").format("MMM DD, YYYY")
      );
    } else if (selectedMode === "month") {
      setStartDate(
        moment(startDate, "MMM DD, YYYY").add(1, "month").format("MMM DD, YYYY")
      );
      setEndDate(
        moment(endDate, "MMM DD, YYYY").add(1, "month").format("MMM DD, YYYY")
      );
    } else if (selectedMode === "year") {
      setStartDate(
        moment(startDate, "MMM DD, YYYY").add(1, "year").format("MMM DD, YYYY")
      );
      setEndDate(
        moment(endDate, "MMM DD, YYYY").add(1, "year").format("MMM DD, YYYY")
      );
    }
  };
