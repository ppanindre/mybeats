...
export const APPOINTMENT_LIST_BY_PATIENT_REQUEST =
    "APPOINTMENT_LIST_BY_PATIENT_REQUEST";
export const APPOINTMENT_LIST_BY_PATIENT_SUCCESS =
    "APPOINTMENT_LIST_BY_PATIENT_SUCCESS";
export const APPOINTMENT_LIST_BY_PATIENT_FAILURE =
    "APPOINTMENT_LIST_BY_PATIENT_FAILURE";

export const APPOINTMENT_UPDATE_NOTES_REQUEST =
    "APPOINTMENT_UPDATE_NOTES_REQUEST";
export const APPOINTMENT_UPDATE_NOTES_SUCCESS =
    "APPOINTMENT_UPDATE_NOTES_SUCCESS";
export const APPOINTMENT_UPDATE_NOTES_FAILURE =
