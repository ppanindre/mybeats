...
const PatientPrscriptionImagesScreen = ({ route }) => {
    const { appointmentId } = route.params;
    const dispatch = useDispatch();
    const { loading, prescriptionImages, imageUrls } = useSelector((state) => state.prescriptionImageGetReducer);
            ...
            <ScrollView showsVerticalScrollIndicator={false} className="flex-1 space-y-10">
                {imageUrls && imageUrls.length > 0 && (
                    <View className="space-y-2">
                        ...
                        <View className="border-dashed border-2 rounded-lg p-2 justify-center items-center h-[475px] bg-darkSecondary" 
...
export default PatientPrscriptionImagesScreen;
