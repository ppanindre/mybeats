...
const FoodEditComponent = ({
  ...
  useEffect(() => {
    ...
    // }
    if (autoFillFoodData && autoFillFoodData != null) {
      setFoodMessage(autoFillFoodData);
    }
    setProteinError(false);
    setCarbError(false);
    setFatError(false);
  ...
  return (
    <View>
      <View className="p-5" style={{ width: "100%" }}>
        ...
        >
          {foodMessage.length > 0 && (
            <View className="bg-light border-2 border-primary rounded-lg py-3 px-5 my-5">
              <View className="flex-row items-center space-x-3">
                ...
                />
                <View className="pr-5">
                  <Text>{foodMessage}</Text>
                  <Text></Text>
                  <Text>Please provide appropriate values in the fields below.</Text>
                </View>
              </View>
            </View>
          )}
