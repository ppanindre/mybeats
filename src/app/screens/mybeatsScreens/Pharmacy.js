    ...
    return (
        ...
        <View className="relative h-full">
            <ScrollView className="p-2 bg-white mb-12">
                    ...
                    <View className="flex-row items-center px-4 py-2">
                        ...
                        <View className="ml-6">
                            ...
                            <View className="flex-row items-center mt-1">
                                ...
                                <Text style={{color: customTheme.colors.dark}} className="text-s ml-1 mr-6 font-[appfont]">{rating}(500+ Ratings)</Text>
                ...
                <View className="flex-row justify-between items-center mt-5 bg-cyan-100 p-5 rounded-lg shadow mx-4" style={{backgroundColor: customTheme.colors.lightPrimary}}>
                    <View className="flex-row items-center">
                        <Ionicons name="business" size={24} style={{color: customTheme.colors.light}} className="bg-blue-100 p-1 rounded-full" />
                        <Text className="text-black-600 text-sm ml-2 font-[appfont-semi]" style={{color: customTheme.colors.light}}>Pharmacy Appointment</Text>
                    </View>
                ...
                <View style={{backgroundColor: customTheme.colors.light}} className="mt-4 mb-12 p-4 rounded-lg shadow mx-4">
                    <Text className="text-xl mb-3 font-[appfont-semi]">Pharmacy Details</Text>
                    ...
                    <TouchableOpacity style={{backgroundColor: customTheme.colors.primary}} className="mt-3 text-white rounded-md py-2 px-4">
                        <View className="flex-row justify-center items-center">
                            ...
                            <Text style={{color: customTheme.colors.light}} className="ml-2 font-[appfont-semi]">Contact Pharmacy</Text>
                        </View>
                    </TouchableOpacity>
                </View>
            ...
            {/* Overlay buttons and book appointment */}
            <View className="absolute bottom-0 left-0 right-0 flex-row justify-between mx-6 py-3 bg-white">
                <TouchableOpacity style={{backgroundColor: customTheme.colors.primary}} className="flex-1 m-1 py-4 rounded-lg flex-row justify-center items-center">
                    ...
                    <Text style={{color: customTheme.colors.light}} className=" ml-2 font-[appfont-semi]">Search Medicines</Text>
                </TouchableOpacity>
                <TouchableOpacity
