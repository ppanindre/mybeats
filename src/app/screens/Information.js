...
const Information = () => {
    ...
    // Navigation instance & dispatch instance
                    ...
                    >
                        ...
                        >
                            <View>
                                ...
                                >
                                    Tap on {">"} or {"<"} to navigate to next or
                                    previous day data.
                                </Text>
                                <View
                                    style={{
                                ...
                                <Text
                                    style={{ textAlign: "center", margin: 20 }}
                                >
                                    Swipe left or right to view the details of
                                ...
                                <Text
                                    style={{ textAlign: "center", margin: 20 }}
                                >
                                    Tap here to contact us if needed, provide
                                    feedback for the application, and quit the
                                    participation.
                                </Text>
                                <View
                                    style={{
                                ...
                                <Text
                                    style={{ textAlign: "center", margin: 20 }}
                                >
                                    Tap here to navigate to view the daily
                                    summary dashboard.
                                </Text>
                                <View
                                    style={{
                                ...
                                <Text
                                    style={{ textAlign: "center", margin: 20 }}
                                >
                                    Tap here to navigate to learn information
                                    about various charts in the application.
                                </Text>
                                <View
                                    style={{
                                        display: "flex",
                                ...
                                <Text
                                    style={{ textAlign: "center", margin: 20 }}
                                >
                                    Tap here to navigate to view daily heart
                                    rate data.
                                </Text>
                                <View
                                    style={{
                                ...
                                <Text
                                    style={{ textAlign: "center", margin: 20 }}
                                >
                                    Tap here to navigate to view daily activity
                                    levels.
                                </Text>
                                <View
                                    style={{
                                ...
                                <Text
                                    style={{ textAlign: "center", margin: 20 }}
                                >
                                    Tap here to navigate to view daily sleep
                                    behavior.
                                </Text>
                                <View
                                    style={{
                                ...
                                <Text
                                    style={{ textAlign: "center", margin: 20 }}
                                >
                                    Tap here to navigate to view details of
                                    daily calorie intake and water consumption.
                                </Text>
                            </View>
                        </List.Accordion>
                    </ScrollView>
