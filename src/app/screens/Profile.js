...
const Profile = () => {
  ...
  const logoutUser = async () => {
    await userQueries.logoutUser(dispatch, user);
  };
  ...
  const removeDevice = async () => {
    ...
    try {
      ...
      if (updatedDevicesData.length == 0) {
        ...
        mailQueries.sendRemoveDeviceMail(user.userId);
      }
    } catch (error) {
            ...
            <View className="items-center mb-5">
              ...
              {devicesData.length === 0 ? (
                ...
                <View style={{ height: 200, width: 200 }} className="relative">
                  ...
                  >
                    ...
                    <View>
                      ...
                      >
                        <Text className="text-light">Add Device</Text>
                      </View>
                    </View>
                  </TouchableOpacity>
                </View>
                ...
                <View className="flex-row items-center gap-4">
                  ...
                  <View
                    className="items-center justify-center border-4 border-primary rounded-full"
