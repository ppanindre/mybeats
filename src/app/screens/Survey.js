...
const surveyQuestions = [
  ...
  "I liked the app’s overall design, gamification features, and social engagement elements.",
  "The app is easy-to-use, interactive, and has a good built-in user experience.",
  "This app can assist the firefighters in improving their health and wellness.",
];
...
const NewSurvey = () => {
  ...
  useEffect(() => {
    const postAnswers = async () => {
      ...
      Alert.alert("", "Thank you for filling out the survey");
  ...
  const addAnswer = () => {
    if (checked === null) {
      Alert.alert("", "Please select an option to go to the next question");
    } else {
          ...
          <View>
            ...
            {questionIndex !== 9 ? (
              ...
              <CustomButton
                ...
                variant="primary"
                btnLabel={
                  isLoading ? <ActivityIndicator color="#ffffff" /> : "Finish"
                }
              />
            )}
          </View>
          ...
          <View>
            <View className="mb-5">
              <Text className="text-lg">
                ...
                ease-of-use, and helpfulness using the rating scale provided
                below. Click on a number that best reflects how you feel. That
                is, select 1 if you
                <Text className="font-bold"> strongly disagree</Text>, and 5 if
                you <Text className="font-bold">strongly agree</Text> with the
